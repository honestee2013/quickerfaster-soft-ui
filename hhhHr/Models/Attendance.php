...
class Attendance extends Model 
{
    ...
    protected $fillable = [
        'employee_id', 'date', 'net_hours', 'sessions', 'status', 'is_approved', 'approved_by', 'approved_at', 'notes', 'needs_review', 'leave_request_id', 'absence_type', 'is_unplanned', 'absence_reason', 'is_paid_absence', 'hours_deducted'
    ];
