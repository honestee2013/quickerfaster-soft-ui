...
return [
  ...
  'fieldDefinitions' => [
    'calendar_id' => [
      ...
      'fillable' => true,
      'description' => 'Which calendar this holiday belongs to',
    ...
    'description' => [
      ...
      'placeholder' => 'Details about the holiday, traditions, or special instructions',
    ...
    'observed_date' => [
      ...
      'description' => 'Date when holiday is observed (if different)',
    ...
    'is_recurring' => [
      ...
      'description' => 'Does this holiday repeat every year?',
      'icon' => 'fas fa-redo',
    ],
    'recurrence_pattern' => [
      'display' => 'inline',
    ...
    'recurrence_rule' => [
      ...
      'placeholder' => 'RRULE:FREQ=YEARLY;BYMONTH=1;BYMONTHDAY=1',
      'description' => 'iCalendar RRULE format for custom recurrence',
      'icon' => 'fas fa-code',
    ],
    'holiday_type' => [
      'display' => 'inline',
      ...
      'description' => 'Category of holiday for reporting',
      'icon' => 'fas fa-tag',
    ],
    'is_paid_holiday' => [
      'display' => 'inline',
      ...
      'description' => 'Is this a paid day off for employees?',
    ...
    'affects_payroll' => [
      ...
      'description' => 'Should this holiday impact payroll calculations?',
    ...
    'business_impact' => [
      ...
      'fillable' => true,
      'modifiers' => [
        'default' => 'office_closed',
      ],
      'description' => 'How this holiday affects company operations',
    ...
    'eligible_employee_types' => [
      ...
      'description' => 'Which employee types get this holiday off',
    ...
    'holiday_pay_rate' => [
      ...
      'description' => 'Pay multiplier for hours worked on this holiday (e.g., 1.5x)',
    ...
    'is_active' => [
      ...
      'description' => 'Is this holiday currently active?',
    ...
    'is_half_day' => [
      ...
      'description' => 'Holiday is only half a day',
      'icon' => 'fas fa-clock',
    ],
    'half_day_end_time' => [
      'display' => 'inline',
      ...
      'description' => 'Time when half day holiday ends',
    ...
    'year' => [
      ...
      'computed' => 'Carbon::parse($date)->year',
    ],
