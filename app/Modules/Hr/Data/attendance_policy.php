...
return [
  ...
  'moreActions' => [
    '0' => [
      ...
      'fieldValue' => true,
      'actionName' => 'set_policy_default',
      'confirm' => 'Set this as the default attendance policy?',
      'condition' => [
        '0' => [
          'is_default' => false,
        ],
    ...
    '2' => [
      ...
      'route' => 'attendance-policies.create-version',
      'params' => [
        'policy_id' => '{id}',
      ],
    ],
    '3' => [
      'title' => 'Export Policy Rules',
      'icon' => 'fas fa-file-export',
      'route' => 'attendance-policies.export.rules',
      'params' => [
        'policy_id' => '{id}',
      ],
    ],
