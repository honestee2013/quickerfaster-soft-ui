...
class AttendanceSession extends Model 
{
    ...
    protected $fillable = [
        'attendance_id', 'clock_in_event_id', 'clock_out_event_id', 'start_time', 'end_time', 'duration_hours', 'session_type', 'is_overnight', 'is_adjusted', 'adjustment_reason', 'adjusted_by'
    ];
